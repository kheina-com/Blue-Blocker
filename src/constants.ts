...
export const DefaultOptions: Config = {
	...
	blockPromoted: false,
	blockNonASCIIUsername: false,
	blockNonASCIIFullText: false,
...
export const ReasonNameNonASCII: number = 5;
export const ReasonFullTextNonASCII: number = 6;
export const ReasonMap = {
	...
	[ReasonNameNonASCII]: "non-ASCII characters in username",
	[ReasonFullTextNonASCII]: "non-ASCII characters in tweet text",
};
